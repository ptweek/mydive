    ...
    <div className="relative z-20 container flex flex-col items-center justify-center gap-12 px-4 py-16">
      ...
      <div className="flex flex-col items-center gap-4 sm:flex-row">
        ...
        <Button
          size="lg"
          variant="shadow"
          className="w-full border-2 border-white bg-white/50 text-lg font-semibold tracking-wider text-white uppercase backdrop-blur-sm hover:bg-white/20 hover:shadow-xl hover:shadow-white/20 sm:w-48"
          onPress={() => {
