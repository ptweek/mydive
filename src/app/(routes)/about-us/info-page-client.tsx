    ...
    <div className="min-h-screen text-white">
      ...
      <section className="relative flex min-h-screen items-center justify-center">
        ...
        <div className="relative z-10 mx-auto max-w-6xl px-6 text-center">
          <div className="rounded-2xl bg-black/50 p-8 backdrop-blur-md">
            <GradualSpacing text="We Are Not Another Dropzone" />
            <p className="mx-auto max-w-4xl text-xl leading-relaxed text-gray-100 md:text-2xl">
      ...
      <section className="px-6 py-12">
        <div className="mx-auto max-w-6xl">
          <div className="grid items-center gap-12 lg:grid-cols-2">
            <div className="space-y-6 rounded-2xl bg-black/40 p-8 backdrop-blur-md">
            ...
            <div className="relative">
              <div className="rounded-3xl border border-white/20 bg-black/50 p-6 backdrop-blur-md">
                <h3 className="mb-4 text-center text-2xl font-bold">
                  Our Mission
                </h3>
                <p className="mb-6 text-center leading-relaxed text-gray-200">
                  Take skydiving out of strip-mall airports and put it back
                  where it belongs — in nature.
                </p>
                <div className="text-center">
                  <span className="inline-block rounded-full bg-gradient-to-r from-blue-500 to-purple-500 px-6 py-3 font-semibold text-white shadow-lg">
                    Skydiving 2.0
                  </span>
                </div>
              </div>
      ...
      <section className="px-6 py-12">
        <div className="mx-auto max-w-6xl">
          ...
          <div className="mx-auto max-w-4xl space-y-6 rounded-2xl bg-black/40 p-8 text-lg leading-relaxed text-gray-200 backdrop-blur-md">
            <p>
      ...
      <section className="px-6 py-16 text-center">
        <div className="mx-auto max-w-4xl rounded-2xl bg-black/40 p-8 backdrop-blur-md">
          ...
          <div className="flex flex-col justify-center gap-6 sm:flex-row">
            ...
            <button
              ...
              className="group relative overflow-hidden rounded-full border-2 border-white/50 bg-black/30 px-8 py-4 text-lg font-semibold text-white backdrop-blur-sm transition-all duration-300 hover:border-white/70 hover:bg-white/20"
            >
